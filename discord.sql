...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2018 at 06:17 AM
...
-- Database: `discord`
--
CREATE DATABASE IF NOT EXISTS `discord` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `discord`;
...
--
ALTER TABLE `channels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2192;
